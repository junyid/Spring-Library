...
export const LoansModal: React.FC<{
    ...
    return (
        <div className={'modal fade'}
             ...
             aria-hidden={'true'} key={props.shelfCurrentLoan.book.id}>
                            ...
                            <div className={'mt-3'}>
                                <div className={'row'}>
                                    <div className={'col-2'}>
                                        {props.shelfCurrentLoan.book?.img ?
                                            <img src={props.shelfCurrentLoan.book?.img} width={56} height={87}
                                                 alt={'Book'}/> :
                                            <img src={require('../../../Images/BooksImages/default.png')} width={56}
                                                 height={87} alt={'Book'}/>
                                        }
                                    </div>
                                ...
                                {props.shelfCurrentLoan.daysLeft > 0 &&
                                    <p className={'text-secondary'}>Due
                                        in {props.shelfCurrentLoan.daysLeft} days.</p>}
                                {props.shelfCurrentLoan.daysLeft === 0 &&
                                    <p className={'text-success'}>Due today.</p>}
                                {props.shelfCurrentLoan.daysLeft < 0 && <p className={'text-danger'}>Past due
                                    by {props.shelfCurrentLoan.daysLeft} days.</p>}
