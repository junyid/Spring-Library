...
import {Messages} from "../MessagesPage/components/Messages";
...
export const ManageLibraryPage = () => {
    ...
    const changeQuantityClickFunction = () => {
                ...
                <nav>
                    <div className={'nav nav-tabs'} id={'nav-tab'} role={'tablist'}>
                        <button className={'nav-link active'} id={'nav-add-book-tab'} data-bs-toggle={'tab'}
                                data-bs-target={'#nav-add-book'} type={'button'} role={'tab'}
                        ...
                        <button className={'nav-link'} id={'nav-quantity-tab'} data-bs-toggle={'tab'}
                                data-bs-target={'#nav-quantity'} type={'button'} role={'tab'}
                                aria-controls={'nav-quantity'}
                                aria-selected={'true'} onClick={changeQuantityClickFunction}>
                            Change quantity
                        </button>
                        <button className={'nav-link'} id={'nav-messages-tab'} data-bs-toggle={'tab'}
                                ...
                                aria-selected={'false'} onClick={messagesClickFunction}>
                            Messages
                        </button>
                    </div>
                </nav>
