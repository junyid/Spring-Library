                    ...
                    <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
                        <div className='ml-2'>
                            ...
                            <p className='lead'>
                                ...
                                Whether it is to learn a new piece or grow within one.
                            </p>
                            {authState?.isAuthenticated ? <Link
                                to='/search'
                    ...
                    <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
                        <div className='ml-2'>
                            ...
                            <p className='lead'>
                                ...
                                work non-stop to provide the best books for you. We are diligent
                                about our book selection and our books are always going to be
                                our top priority.
                            </p>
                        </div>
                    </div>
